...
// Port of glsl/cell_bg.f.glsl. Changes:
//  - Removed `layout(origin_upper_left) in vec4 gl_FragCoord;`
//    (Vulkan's fragcoord origin is always upper-left).
//  - SSBO moved to set 0, binding 1.
